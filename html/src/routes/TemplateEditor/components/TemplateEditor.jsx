...
import {Col, FormControl, FormGroup, Panel, Row} from 'react-bootstrap'
import {browserHistory} from 'react-router'
// import {Link} from "react-router";
import Editor from './Editor.jsx'
import s from './TemplateEditor.scss'
      ...
      <div className='editor-container'>
        <Row>
          ...
          <div className='title-container'>
            <h2>
              <span
                className='name cursorPointer'
                onClick={() => browserHistory.push('/dashboard/templates')}>Templates<span/>
                <i
                  className='fa fa-caret-right icon'
                  aria-hidden='true'></i>
              </span>
              <span className='nameTitle'>Intro Email</span>
            </h2>
            <Col
              md={12}
              offset={12}>
              <button className={cn(s.btn, 'pull-right')}>New template</button>
            </Col>
          </div>
          {/*title container end*/}
        </Row>
            ...
            <Panel className='panel'>
              <Col
                ...
                <div className='btn-group'>
                  <button className={cn(s.btn, 'pull-right save both')}>Save</button>
                  <button className={cn(s.btn, 'pull-right both')}>Cancel</button>
                </div>
              </Col>
            </Panel>
          </Col>
                    ...
                    return (
                      <div
                        ...
                        <div >
                          ...
                          <button className={cn(s.btn, s['btn-default'], 'pull-right')}>Insert</button>
