          ...
          <Panel key={key}>
            <Row className='show-grid'>
              ...
              <Col
                ...
                <button
                  type='button'
                  className={cn(s.btn, 'btns contact-btn')}> Lead Won
                </button>
                <button
                  type='button'
                  className={cn(s.btn, 'btns contact-btn')}> Lead Lost
                </button>
                <div className='Line'/>
                <button
                  type='button'
                  className={cn(s.btn, 'btns contact-btn')}> Skip Step
                </button>
                <button
                  type='button'
                  className={cn(s.btn, 'btns contact-btn-green')}> Completed
                </button>
              </Col>
            </Row>
          </Panel>
