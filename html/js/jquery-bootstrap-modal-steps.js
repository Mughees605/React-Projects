    ...
    $.fn.modalSteps = function(options){
        ...
        $modal
            .on('show.bs.modal', function(){
                ...
                // added by Hassan Elmi
                $modal.find('.first-step').addClass('active-step');
                $modal.find('.user-icon').addClass('active-icon');
            })
        ...
        $modal.find('.js-btn-step').on('click', function(){
            ...
            if (orientation === 'next'){
                ...
                // added by Hassan Elmi
                $modal.find('.first-step').removeClass('active-step');
                $modal.find('.second-step').addClass('active-step');
                $modal.find('.user-icon').removeClass('active-icon');
                $modal.find('.card-icon').addClass('active-icon');
                ...
                // added by Hassan Elmi
                $modal.find('.second-step').removeClass('active-step');
                $modal.find('.first-step').addClass('active-step');
                $modal.find('.user-icon').addClass('active-icon');
                $modal.find('.card-icon').removeClass('active-icon');
